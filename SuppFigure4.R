...
#####################################################################
## Supplementary Figure 4: Conserved RT and ART
#####################################################################
...
ggplot(plot_data, aes(y = perc, axis1 = INHOUSE, axis2 = ENCODE)) +
  ...
  scale_x_discrete(limits = c("ENCODE", "IN-STUDY"), expand = c(.05, .05)) +
...
#####################################################################
### Supplementary Figure 4B: ART per cancer type being conserved RT or not ========
